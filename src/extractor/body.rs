    ...
    where S: StreamExt<Item=Result<hyper::Chunk, hyper::Error>> + Unpin
{
    ...
    match encoding {
        ...
        ContentEncoding::Gzip => {
            let mut decoder = flate2::write::GzDecoder::new(utils::BytesWriter::with_capacity(buffer_size));
        ...
        ContentEncoding::Deflate => {
            let mut decoder = flate2::write::ZlibDecoder::new(utils::BytesWriter::with_capacity(buffer_size));
